...
└── 配音/      # 包含该场景的配音文件（可选）
        ...
        "volume_settings": """
        <h3>音量设置</h3>
        <p>调整配音和背景音乐的相对音量，获得最佳听觉体验</p>
        <p><b>配音音量</b>：调整人声配音的音量倍率（0-5倍）</p>
        <ul>
            <li>1.0倍 - 保持原始音量不变</li>
            <li>&lt;1.0 - 降低音量</li>
            <li>&gt;1.0 - 提高音量</li>
        </ul>
        <p><b>背景音量</b>：调整背景音乐的音量倍率（0-5倍）</p>
        <ul>
            <li>推荐设置背景音乐音量低于配音音量，典型值为0.3-0.7</li>
            <li>设置为0可以完全关闭背景音乐</li>
        </ul>
        <p>注意：过高的音量可能导致音频失真，建议在保持清晰度的同时，避免音量过高</p>
        """,
        ...
        <h4>快捷方式支持</h4>
        <p>现在支持使用Windows快捷方式(.lnk)作为子文件夹，可以节省磁盘空间</p>
        <ol>
        ...
        <p><b>提示</b>：导入后，素材会按照文件夹名称排序，影响最终视频中场景的顺序</p>
        """,
